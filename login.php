...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
  ...
  <a class="navbar-brand" href="#" style="font-size:30px;"><strong>S University</strong></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline p-10 my-10 ml-10 my-lg-0">
      <a href="register.php"class="btn btn-success my-2 my-sm-0" type="submit">Create Account</a>
    </form>
      <form class="form-inline my-10 my-lg-0">
      <a href="login.php"class="btn btn-success my-2 my-sm-0" type="submit">Admin Login</a>
    </form>
  </div>
</nav>
